...
BuildRequires:  php-composer(%{gh_owner}/zend-router)                >= 2.5
BuildRequires:  php-composer(%{gh_owner}/zend-psr7bridge)            >= 0.2.0
...
Requires:       php-composer(%{gh_owner}/zend-router)                >= 2.5
Requires:       php-composer(%{gh_owner}/zend-router)                <  3
Requires:       php-composer(%{gh_owner}/zend-psr7bridge)            >= 0.2.0
