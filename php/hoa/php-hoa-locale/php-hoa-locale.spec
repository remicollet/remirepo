# remirepo/fedora spec file for php-hoa-locale
#
...
#
%global bootstrap    1
%global gh_commit    daa8f9a18a3cbd467cefc6ffbd94fa0cb091b3ff
...
%global ns_project   Locale
%global pk_vendor    hoa
%global pk_project   locale
%if %{bootstrap}
...
%description
The %{ns_vendor}\%{ns_project} library allows to get the informations
of the locale from the system, the HTTP client or something else.
...
%changelog
* Wed Apr  6 2016 Remi Collet <remi@fedoraproject.org> - 2.16.01.14-0
- initial package
- bootstrap build
