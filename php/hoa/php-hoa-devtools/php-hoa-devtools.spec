# remirepo/fedora spec file for php-hoa-devtools
#
...
#
%global bootstrap    1
%global gh_commit    e6e1210e6528b5f02bee9f78baa6d5aa0f7198c1
#global gh_date      20150728
%global gh_short     %(c=%{gh_commit}; echo ${c:0:7})
%global gh_owner     hoaproject
%global gh_project   Devtools
%global php_home     %{_datadir}/php
%global ns_vendor    Hoa
%global ns_project   Devtools
%global pk_vendor    hoa
%global pk_project   devtools
%if %{bootstrap}
...
BuildArch:      noarch
%if %{with_tests}
BuildRequires:  php-composer(%{pk_vendor}/cli)             >= 2.0
...
BuildRequires:  php-composer(%{pk_vendor}/xyl)             >= 1.0
%endif
...
#        "hoa/router"     : "~3.0",
#        "hoa/xyl"        : "~1.0"
Requires:       php-composer(%{pk_vendor}/cli)             >= 2.0
Requires:       php-composer(%{pk_vendor}/cli)             <  3
...
Requires:       php-composer(%{pk_vendor}/xyl)             >= 1.0
Requires:       php-composer(%{pk_vendor}/xyl)             <  2
...
%description
The %{ns_vendor}\%{ns_project} library contains several development tools.
This is for developers or maintainers. Sometimes it can be useful to users
also, but in particular cases.
...
%changelog
* Thu Apr 14 2016 Remi Collet <remi@fedoraproject.org> - 1.16.01.15-0
- initial package
- bootstrap build
