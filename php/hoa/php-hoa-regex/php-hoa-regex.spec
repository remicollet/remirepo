# remirepo/fedora spec file for php-hoa-regex
#
...
#
%global bootstrap    1
%global gh_commit    e7fb36fdea23ea9fc814a1a68bd0144df1891463
#global gh_date      20150728
%global gh_short     %(c=%{gh_commit}; echo ${c:0:7})
%global gh_owner     hoaproject
%global gh_project   Regex
%global php_home     %{_datadir}/php
%global ns_vendor    Hoa
%global ns_project   Regex
%global pk_vendor    hoa
%global pk_project   regex
%if %{bootstrap}
...
%description
The %{ns_vendor}\%{ns_project} library provides tools to analyze
regular expressions and generate strings based on regular expressions
(Perl Compatible Regular Expressions, http://pcre.org/).
