# remirepo/fedora spec file for php-hoa-visitor
#
...
#
%global bootstrap    1
%global gh_commit    cb21074b7eb89c3ac9f76d25c72671d579735ca9
#global gh_date      20150728
%global gh_short     %(c=%{gh_commit}; echo ${c:0:7})
%global gh_owner     hoaproject
%global gh_project   Visitor
%global php_home     %{_datadir}/php
%global ns_vendor    Hoa
%global ns_project   Visitor
%global pk_vendor    hoa
%global pk_project   visitor
%if %{bootstrap}
...
# from phpcompatinfo report for version 2.16.01.11
# none
...
%description
The %{ns_vendor}\%{ns_project} library provides interfaces
to apply the visitor pattern.
...
%changelog
* Wed Apr  6 2016 Remi Collet <remi@fedoraproject.org> - 2.16.01.11-0
- initial package
- bootstrap build
