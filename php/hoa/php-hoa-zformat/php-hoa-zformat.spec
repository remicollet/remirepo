# remirepo/fedora spec file for php-hoa-zformat
#
...
#
%global bootstrap    1
%global gh_commit    d261637aa6f4485d697ebcb898a379f7a34b4e34
#global gh_date      20150728
%global gh_short     %(c=%{gh_commit}; echo ${c:0:7})
%global gh_owner     hoaproject
%global gh_project   Zformat
%global php_home     %{_datadir}/php
%global ns_vendor    Hoa
%global ns_project   Zformat
%global pk_vendor    hoa
%global pk_project   zformat
%if %{bootstrap}
...
%description
The %{ns_vendor}\%{ns_project} library provides a new format
called zFormat, used to express complex parameters, for instance
for classes.
...
%changelog
* Wed Apr  6 2016 Remi Collet <remi@fedoraproject.org> - 1.16.03.15-0
- initial package
- bootstrap build
