...
%endif
# Test suite disable by default as requires online
%global with_tests %{?_with_tests:1}%{!?_with_tests:0}

Summary:        Asynchronous Resolver
Name:           %{?scl_prefix}php-pecl-ares
Version:        0.8.0
...
%description
Binding for the c-ares (CURL) library.
...
extver=$(sed -n '/#define PHP_ARES_VERSION/{s/.* "//;s/".*$//;p}' php_ares.h)
