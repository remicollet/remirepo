# remirepo spec file for php-pecl-xrange
#
...
# https://bugs.php.net/65846 Please Provides LICENSE file
...
extver=$(sed -n '/#define PHP_XRANGE_VERSION/{s/.* "//;s/".*$//;p}' php_xrange.h)
...
%changelog
* Wed Mar  9 2016 Remi Collet <remi@fedoraproject.org> - 1.3.2-6
- adapt for F24
- drop runtime dependency on pear, new scriptlets
- fix license management
- don't install/register tests

* Wed Dec 24 2014 Remi Collet <remi@fedoraproject.org> - 1.3.2-5.1
- Fedora 21 SCL mass rebuild

* Tue Aug 26 2014 Remi Collet <rcollet@redhat.com> - 1.3.2-5
- improve SCL build

* Thu Apr 17 2014 Remi Collet <remi@fedoraproject.org> - 1.3.2-4
