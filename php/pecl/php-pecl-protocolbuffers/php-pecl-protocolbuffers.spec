...
#
%{?scl:          %scl_package        php-pecl-protocolbuffers}
...
%changelog
* Tue Mar  8 2016 Remi Collet <remi@fedoraproject.org> - 0.2.6-3
- adapt for F24
- drop runtime dependency on pear, new scriptlets
- fix license management
- don't install/register tests

* Wed Dec 24 2014 Remi Collet <remi@fedoraproject.org> - 0.2.6-2.1
- Fedora 21 SCL mass rebuild

* Tue Aug 26 2014 Remi Collet <rcollet@redhat.com> - 0.2.6-2
- improve SCL build
