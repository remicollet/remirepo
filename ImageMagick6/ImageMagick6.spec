...
* Sun Mar  5 2017 Remi Collet <remi@remirepo.net> - 6.9.7.10-1
- update to version 6.9.7 patch level 10

* Sat Feb 18 2017 Remi Collet <remi@remirepo.net> - 6.9.7.9-1
- update to version 6.9.7 patchlevel 9

* Tue Feb 14 2017 Remi Collet <remi@remirepo.net> - 6.9.7.8-1
- update to version 6.9.7 patchlevel 8

* Mon Feb  6 2017 Remi Collet <remi@remirepo.net> - 6.9.7.7-1
- update to version 6.9.7 patchlevel 7
...
* Mon Jan 16 2017 Remi Collet <remi@remirepo.net> - 6.9.7.4-1
- update to version 6.9.7 patchlevel 4

* Sun Jan  8 2017 Remi Collet <remi@remirepo.net> - 6.9.7.3-1
- update to version 6.9.7 patchlevel 3

* Wed Jan  4 2017 Remi Collet <remi@remirepo.net> - 6.9.7.2-1
...
* Tue Nov 15 2016 Remi Collet <remi@remirepo.net> - 6.9.6.5-1
- update to version 6.9.6 patchlevel 5

* Wed Nov  9 2016 Remi Collet <remi@remirepo.net> - 6.9.6.4-1
- update to version 6.9.6 patchlevel 4

* Tue Nov  1 2016 Remi Collet <remi@remirepo.net> - 6.9.6.3-1
- update to version 6.9.6 patchlevel 3

* Tue Oct 11 2016 Remi Collet <remi@remirepo.net> - 6.9.6.2-1
- update to version 6.9.6 patchlevel 2

* Sun Oct  9 2016 Remi Collet <remi@remirepo.net> - 6.9.6.1-1
- update to version 6.9.6 patchlevel 1
...
- add upstream patch for
  https://github.com/ImageMagick/ImageMagick/issues/245

* Sat Jul 30 2016 Remi Collet <remi@remirepo.net> - 6.9.5.4-1
- update to version 6.9.5 patchlevel 4

* Sat Jul 23 2016 Remi Collet <remi@remirepo.net> - 6.9.5.3-1
- update to version 6.9.5 patchlevel 3
...
* Fri Jun  3 2016 Remi Collet <remi@remirepo.net> - 6.9.4.7-1
- update to version 6.9.4 patchlevel 7

* Fri Jun  3 2016 Remi Collet <remi@remirepo.net> - 6.9.4.6-1
- update to version 6.9.4 patchlevel 6
...
* Wed May  4 2016 Remi Collet <remi@remirepo.net> - 6.9.3.10-1
