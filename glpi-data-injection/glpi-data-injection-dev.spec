...
%if 0%{?svnrelease}
# svn export -r 593 https://forge.indepnet.net/svn/datainjection/trunk datainjection
# tar czf glpi-datainjection-2.1.0-593.tar.gz datainjection
